...
colframe=green!55!black,colupper=blue!40!black]\begin{xca}}{\end{xca}\end{tcolorbox}}
...
{\begin{tcolorbox}[boxrule=0pt,frame hidden,colback=red!5!white,
  ...
  beforeafter skip balanced=.4\baselineskip plus 2pt,
  before upper={\parindent4mm\noindent},
colframe=red!55!black,colupper=blue!40!black]\begin{exa}}{\end{exa}\end{tcolorbox}}
