...
real central division algebra is isomorphic to $\R$ or $\mathbb{H}$. 
...
The previous exercise and Hopkins-Levitzki theorem imply that 
artinian unitary rings are Dedekind-finite. Can you write a 
proof without using Hopkins--Levitzki? 
