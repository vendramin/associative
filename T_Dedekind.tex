...
\index{Ring!Dedekind-finite}
    Let $R$ be a ring with one. We say that $R$ is \emph{Dedekind-finite} if 
...
\index{Module!Dedekind-finite}
    Let $R$ be a unitary ring. An $R$-module is said to be \emph{Dedekind-finite}
...
\index{Ring!reversible}
    A ring $R$ is said to be \emph{reversible} if for all $a,b\in R$ 
