...
If $(X,r)$ is a solution (to the YBE), 
by convention we write 
\[
	r(x,y)=(\sigma_x(y),\tau_y(x)).
\]

We say that a solution $(X,r)$ is \emph{involutive} 
if $r^2=\id$, and \emph{non-degenerate} if the maps 
...
\begin{proof}
	...
	\]
	for some $b_1,\dots,b_m\in K$. Since $J(A)$ is an ideal,
...
\begin{corollary}
Let $K$ be an uncountable field. If $A$ is an algebra
