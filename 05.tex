...
\label{xca:R/I_field_or_zero}
    Let $R$ be a commutative ring with no proper 
    ideals and $I$ be an ideal of $R$. Prove that
...
\begin{proof}
    ...
    $0=\pi(xy)=\pi(x)\pi(y)$ for all $x,y\in R$. Note that
    $R/I$ has characteristic $p$, as $0=\pi(px)=p\pi(x)$ for all $x\in R$, 
    since $pR\subseteq I$. Thus $R/I$ is a vector space 
    over the field $\Z/p$.
