...
\begin{proof}
	Let $I$ be a left maximal regular ideal of the ring $A$. We claim that
	...
	\]
	Since $I$ is maximal, it follows that $I+\lambda I=A$. The regularity of $I$ implies that there exists $e\in R$
	such that 
	...
	\]
	Since $e^2-e\in I$ y $e^2\in I$, it follows that $e\in I$. Thus $A=I$, as
	$a-ae\in I$ for all $a\in A$, a contradiction.

	Conversely, if $I$ is a left maximal regular ideal of the algebra $A$, then 
	$I$ is a regular left ideal of the ring $A$. We claim that $I$ is maximal. 
	There exists a maximal left ideal $L$ of the ring $A$ that contains $I$. Since 
	$L$ is regular, it follows that $L$ is a regular maximal left ideal of the ring $A$. Thus 
	$L=I$ because $I$ is maximal. 
...
\begin{theorem}
	...
	If $A$ is an algebraic algebra, then $J(A)$ is the largest nil ideal of $A$.
\end{theorem}
...
\begin{proof}
	...
	hence $J(A)$ is a nil ideal by Theorem~\ref{thm:algebraica=>Jnil}.
	...
	and is such that $f(a)=0$. Since $a\in J(A)$ is algebraic, it follows
