...
\begin{proof}
    Since $I$ is primitive, then $R/I$ is primitive (Exercise~\ref{xca:primitivo}). By Wedderburn's theorem, 
...
\begin{proof}
    If $I_1,I_2\dots$ are infinitely many distinct primitive ideals. 
